package com.code.proter.user.logger.aop;

import com.alibaba.fastjson.JSONObject;
import com.code.proter.user.logger.service.ILogActionService;
import com.code.proter.user.shiro.data.Login;
import com.code.proter.common.utils.IPUtil;
...
public class LoginAspect {
    ...
    @Pointcut("@annotation(com.code.proter.user.logger.annotation.Authorization)")
